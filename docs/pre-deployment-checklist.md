...
The branch merge includes all 78 card illustrations and the Lore art under
`static/images/`; B2 is resolved. The history below records the original audit.
Production still requires the `SECRET_KEY` environment variable.
