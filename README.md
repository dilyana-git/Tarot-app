...
> **All 78 card illustrations are included in the repository**, together with
> the Lore artwork. A normal Git-based deployment includes them automatically.
...
The repository tracks the complete 78-card artwork set and Lore illustrations. The
